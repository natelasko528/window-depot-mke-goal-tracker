-- Integration tables for Jotform and Marketsharp

-- Webhook events table
CREATE TABLE IF NOT EXISTS webhook_events (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  source TEXT NOT NULL, -- 'jotform' or 'marketsharp'
  form_id TEXT,
  submission_id TEXT,
  data JSONB,
...
CREATE TABLE IF NOT EXISTS integration_sync_status (
  ...
  integration_type TEXT NOT NULL, -- 'jotform' or 'marketsharp'
